...
{{
  ...
  "summary": "3-sentence recruiter-ready profile written in third person. Sentence 1 — hook: open with the candidate's single strongest quantified achievement or most impressive credential (company brand, award, scale of impact), then name their seniority level, total years of experience, and primary domain. Sentence 2 — depth: list 3-4 hard skills or technology stacks that define their technical identity; name the industries or company types they have worked in if notable. Sentence 3 — value signal: state what kind of role or challenge they are best positioned for, or cite a second distinct achievement that shows breadth. Rules: use exact company names, technologies, and metrics from the CV; if no metric exists write the scope instead (e.g. 'team of 12', 'serving 2M users'); never fabricate; keep each sentence under 35 words. Example: 'Scaled Stripe's payment ledger to $50B/year in transaction volume as a Staff Engineer with 9 years in fintech and distributed systems. Expert in Go, Kafka, and PostgreSQL across high-frequency trading and SaaS platforms. Best suited for principal or staff-level roles at companies handling complex financial or real-time data infrastructure.'",
