...
import {
  ...
  Bot, Layers, AudioLines, Sparkles, Github,
  BriefcaseBusiness,
} from "lucide-react";
    ...
    <>
      ...
      <main className="relative min-h-screen overflow-hidden bg-[var(--canvas)] text-slate-950">
        ...
        <div className="relative mx-auto flex w-full max-w-6xl flex-col px-6 pb-16 pt-6 sm:px-8 lg:px-10">
          ...
          {/* ── FEATURES ────────────────────────────────────────────────────── */}
          <section id="features" className="grid gap-10 border-t border-slate-200/80 py-16 lg:grid-cols-[0.7fr_1.3fr]">
          ...
          {/* ── WORKFLOW ────────────────────────────────────────────────────── */}
          <section className="grid gap-10 border-t border-slate-200/80 py-16 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="space-y-6">
              <div className="max-w-2xl space-y-3">
          ...
          {/* ── PROOF ───────────────────────────────────────────────────────── */}
          <section id="proof" className="grid gap-10 border-t border-slate-200/80 py-16 lg:grid-cols-[0.85fr_1.15fr]">
            <div className="max-w-2xl space-y-3">
          ...
          {/* ── STORY ───────────────────────────────────────────────────────── */}
          <section id="story" className="grid gap-8 border-t border-slate-200/80 py-16 lg:grid-cols-[0.8fr_1.2fr]">
            <div className="max-w-2xl space-y-3">
          ...
          {/* ── FOOTER ──────────────────────────────────────────────────────── */}
          <footer className="flex flex-col gap-4 border-t border-slate-200/80 py-8 text-sm text-slate-500 sm:flex-row sm:items-center sm:justify-between">
